...
>(({ className, children, hideIcon, onClear, ...props }, ref) => (
   <div className="group relative">
      <SelectPrimitive.Trigger
         ref={ref}
         className={cn(
            ' flex h-9 w-full bg-card-bg items-center justify-between whitespace-nowrap rounded-md border border-border px-3 py-2 text-xs ring-offset-background placeholder:text-muted-text focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
            className
         )}
         {...props}
      >
